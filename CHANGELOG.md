...
- GitHub repository, Git branch/remote, filesystem, npm/pnpm/Yarn, SSH, and Docker providers.
- Sanitized local history learning with enable, disable, status, and clear controls.
- Zsh ghost text, compact candidate menu, selection widgets, cancellation, and Emacs-keymap-compatible behavior.
